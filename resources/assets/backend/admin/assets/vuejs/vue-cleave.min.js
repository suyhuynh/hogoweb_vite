...
! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("cleave.js")) : "function" == typeof define && define.amd ? define("VueCleave", ["cleave.js"], t) : "object" == typeof exports ? exports.VueCleave = t(require("cleave.js")) : e.VueCleave = t(e.Cleave)
    ...
    return function(e) {
        ...
        var r = n(2),
            ...
            i = {
                ...
                props: {
                    value: {
                        ...
                        validator: function(e) {
                            return null === e || "string" == typeof e || e instanceof String || "number" == typeof e
                        }
                    },
                    options: {
                        type: Object,
                ...
                mounted: function() {
                    this.cleave || (this.cleave = new o.a(this.$el, this.options), this.cleave.setRawValue(this.value))
                },
                methods: {
                    onInput: function(e) {
                        var t = this;
                        this.$nextTick(function() {
                            var n = t.raw ? t.cleave.getRawValue() : e.target.value;
                            if( t.options.numeral &&  n != '' ){
                            	n = parseInt(n);
                            }
                ...
                watch: {
                    options: {
                        deep: !0,
                        handler: function(e) {
                            this.cleave.destroy(), this.cleave = new o.a(this.$el, e), this.cleave.setRawValue(this.value)
                        }
                    },
                    value: function(e) {
                        this.cleave && this.cleave.setRawValue(e)
                    }
                },
                beforeDestroy: function() {
                    this.cleave && (this.cleave.destroy(), this.cleave = null)
                }
            },
            u = function() {
                var e = this,
        ...
        var d = function(e, t) {
            var n = "cleave";
            "string" == typeof t && (n = t), e.component(n, p)
        };
        p.install = d;
        t.default = p
    }, function(e, t) {
