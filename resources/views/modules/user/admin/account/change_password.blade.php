		...
		<div class="card">
			<div class="card-heading">
				<strong style="text-transform: uppercase;">
					{{ trans('user::users.account.change_password') }}
				</strong>
			</div>
			<div class="card-body">
			...
			<div class="card-footer text-right">
				...
				<button v-on:click="update('{{ route('admin.account.change_password') }}')" class="btn btn-success btn-sm btn-actions btn-store" style="margin-left: 5px;">
