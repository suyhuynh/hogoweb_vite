...
$(document).ready(function() {
    ...
    $(".button--random").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('.code-champ').html('Mã dự thưởng: ' + luckyMan.code);
                $('.phone-champ').html('Số điện thoại: ' + luckyMan.phone)
                $(".odometer").html(""),
                $(".odometer").append(
    ...
    $(".button--stop").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: '/phieu-luu-cung-gulliver-mua-4/lucky.asp',
            headers: {"Authorization": "Kilala SG9Hb1dlYiBIdeG7s25oIE5n4buNYyBTdXkgMDkzMTE1NjgxOA=="},
            // data: { random: random },
            data: { luckyCode: luckyMan.code },
            success: function(res) {
                var listCode = res.codes;
                // luckyCode = listCode[Math.floor(Math.random() * listCode.length)];
                // luckyMan = res.data[luckyCode];
