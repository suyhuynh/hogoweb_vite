        ...
        <div class="tab-contents">
            ...
            <div class="tab-content is-active" id="register">
                <div class="gulliver-box">
                    <h2>Đăng ký tham gia chương trình khảo sát “IPHONE, VỀ TAY AI?”</h2>
                </div>
                    ...
                    <div class="gulliver-box">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <div class="form-control">
                                ...
                                <div class="sex js-checkClass">
                                    <div class="form-check">
                                        <input class="form-check-input" name="extend[sex]" type="radio" id="register-male" value="Nam">
                                        <label class="form-check-label" for="register-male">Nam</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="extend[sex]" type="radio" id="register-female" value="Nữ">
                                        <label class="form-check-label" for="register-female">Nữ</label>
                                    </div>
                                </div>
                            </div> -->
                        </div>
