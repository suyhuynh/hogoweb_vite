        ...
        <div class="tab-contents">
            <div class="rules-page tab-content is-active" id="survey">
                <div class="survey-box">
                    <h2 class="md-block">Câu hỏi khảo sát chương trình fan meeting <br>“Phiêu lưu cùng Gulliver - Mùa 4 Reloaded”</h2>
                    <h2 class="md-none">Câu hỏi khảo sát chương trình fan meeting <br>Phiêu lưu cùng Gulliver <br /> Mùa 4 Reloaded</h2>
                </div>
