! function (modules) {
    ...
    _libs.PDFJS.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : {
        pdfJsWorker: "/public/web/jq-3d-flip-book/js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    ...
    var _extends = Object.assign || function (target) {
        ...
        Book = function (_THREE$EventDispatche) {
            function Book(visual, sheets, pageCallback, props) {
                ...
                return sheets = Math.min(3, sheets), 
                    _this.visual = visual, 
                    _this.mouseController = !0, _this.p = _extends({}, Book.prepareProps(props), {
                    sheets: sheets,
    ...
    var _View2 = (__webpack_require__(1), __webpack_require__(65)),
        ...
        BookView = function (_View) {
            ...
            return _inherits(BookView, _View), BookView.prototype.initView = function () {
                ...
                return {
                    html: "/public/web/jq-3d-flip-book/templates/default-book-view.html",
                    styles: ["/public/web/jq-3d-flip-book/css/black-book-view.css"],
                    links: [{
                        rel: "stylesheet",
                        href: "/public/web/jq-3d-flip-book/css/font-awesome.min.css"
                    }],
                    script: "/public/web/jq-3d-flip-book/js/default-book-view.js"
                }
            }, BookView
        }(_View3.default);
