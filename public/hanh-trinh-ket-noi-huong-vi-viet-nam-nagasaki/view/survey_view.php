            ...
            <div class="tab-contents">
                <ul class="tabs">
                    <li class="tab is-active">
                        <a href="#survey" class="tab-link">Khảo sát</a>
                    </li>
                    <li class="tab">
                ...
                <div class="rules-page tab-content is-active" id="survey">
                    <div class="survey-box">
                        <h2>
                            Câu hỏi khảo sát chương trình <br>“Hành trình kết nối hương vị Việt Nam - Nagasaki”
                        </h2>
                    </div>
                    <form action="<?php echo url('gui-khao-sat.asp') ?>" method="post">
                        <?php foreach ($questions as $question) { ?>
                            <div class="survey" data-id="survey-<?php echo $question['order']; ?>" style="<?php if (strpos($question['order'], '-') !== false) { echo 'display: none;'; } ?>">
                                <div class="question">
                                    <div class="num-ques">
                        ...
                        <div class="btn-center after-degree">
                            <button name="back" type="button" class="button-primary" id="clear-survey" style="background: rgb(198 198 198);border: 1px solid transparent;color: #333;">
                                Trở lại
                            </button>
...
<script type="text/javascript">
    ...
    $(window).on('load',function() {
        $('#survey-25-116').addClass('checkbox-diff');
        $('#survey-25-116').parents('.survey-answers').addClass('list-checkbox');
        $('#survey-26-123').addClass('checkbox-diff');
        $('#survey-26-123').parents('.survey-answers').addClass('list-checkbox');
        $('#survey-27-135').addClass('checkbox-diff');
        $('#survey-27-135').parents('.survey-answers').addClass('list-checkbox');
        $('#survey-31-158').addClass('checkbox-diff');
        $('#survey-31-158').parents('.survey-answers').addClass('list-checkbox');
