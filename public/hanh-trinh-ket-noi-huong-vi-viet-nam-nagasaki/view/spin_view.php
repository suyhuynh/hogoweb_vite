            ...
            <div class="dial-box">
                ...
                <div class="dial-content">
                    <div class="dial-item">
                        <p>Giải thưởng:</p>
                        <ul>
                            <li class="toggle-goals active" id="special-goals">Giải đặc biệt - iPhone 15 (128GB)</li>
                            <li class="toggle-goals" id="first-goals">Giải nhất - Túi Motherhouse</li>
                        </ul>
                    </div>
                    <div class="dial-item">
                        <p>Mã trúng thưởng</p>
                    ...
                    <div class="dial-item">
                        <p>Kết quả quay số:</p>
                        <ul class="result">
                            <li>Giải đặc biệt - iPhone 15 (128GB)
                                <p>Trúng thưởng:<span class="special-code">------</span></p>
                            </li>
                            <li>Giải nhất - Túi Motherhouse
...
<div class="congratulate">
    ...
    <div class="popup-congratulate">
        ...
        <p class="custom-text heading-champ">Chúc Mừng</p>
