<?php
	...
	$entity = CustomerAnswer::findOrCreateByCustomerId($customer['id'], $_POST);
			...
			<div style="width: 560px;background: #fff;padding: 15px;margin: 30px auto;">
				<table style="width: 100%;">
					...
					<tbody>
						<tr>
							<td>
								<p style="margin: 0;">Chương trình hành trình kết nối hương vị Việt Nam - Nagasaki đã nhận được bản khảo sát của bạn.</p>
								<p style="margin: 0;">
									<strong>
