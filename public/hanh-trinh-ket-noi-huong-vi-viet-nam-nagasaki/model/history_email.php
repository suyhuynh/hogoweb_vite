...
class HistoryEmail {
    ...
    public static function createEmail($data = array()) {
        $input = array();
        $input['taxonomy_type'] = 'Modules\\\Kilala\\\Entities\\\CustomerNagasaki';
        $input['taxonomy_id'] = $data['customer_id'];
        $input['lang_code'] = 'vi';
        $input['from_name'] = 'kilala.vn';
        $input['from_email'] = 'nagasaki@kilala.vn';
        $input['recipient_email'] = trim($data['recipient_email']);
        $input['subject'] = 'KILALA - Khảo sát kết nối hương vị Việt Nam Nagasaki';
