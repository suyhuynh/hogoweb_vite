...
class Survey {
    ...
    public static function getAllSurvey() {
        $sql = mysqli_query(dbconnect(),"SELECT * FROM `questions` WHERE `type` LIKE 'nagasaki'");
    ...
    public static function getAllSurveyAnswers() {
        $sql = mysqli_query(dbconnect(),"SELECT * FROM `questions` WHERE `type` LIKE 'nagasaki' ORDER BY `order` ASC");
