...
class Customer {
    ...
    public static function getAllCustomerCode() {
        $sql = mysqli_query(dbconnect(),"SELECT `code`, `fullname`, `phone` FROM `customer_nagasakis` WHERE `status` = 'active'");
    ...
    public static function getAllCustomerCodeFull() {
        $sql = mysqli_query(dbconnect(),"SELECT `code`, `fullname`, `phone` FROM `customer_nagasakis`");
    ...
    public static function getCustomerById($id) {
        $sql = mysqli_query(dbconnect(),
            "SELECT * FROM `customer_nagasakis` WHERE `id` = $id"
        );
    ...
    public static function getCustomerByEmailOrPhone($phone, $email) {
        $sql = mysqli_query(dbconnect(),
            "SELECT * FROM `customer_nagasakis` WHERE `phone` = '" . trim($phone) . "' OR `email` = '" . trim($email) . "'"
        );
		$result = mysqli_fetch_assoc($sql) ;
		return $result;
    }
    ...
    public static function getCustomerByCode($code) {
        $sql = mysqli_query(dbconnect(),
            "SELECT * FROM `customer_nagasakis` WHERE `code` = '" . $code . "'"
        );
		$result = mysqli_fetch_assoc($sql) ;
		return $result;
    }
    ...
    private static function create($data) {
        ...
        $sql = "INSERT INTO `customer_nagasakis` 
		(
            `" . implode("`, `", $keys) . "`
		)
		VALUE 
