	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="{{ route('admin.categories.index', ['code' => request()->code]) }}" class="breadcrumb-item">{{ trans('core::functions.'.request()->code) }}</a>
		...
		<div class="header-elements d-none">
			<div class="breadcrumb justify-content-center">
				<a href="{{ route('admin.categories.update', ['id' => $category->id,'code' => request()->code]) }}" class="btn {{ config('erp.btn_class.update.class') }} btn-sm btn-actions btn-store" style="margin-left: 5px;">
...
<div class="row">
	<div class="col-md-12">
		...
		@slot('edit_design', $category->is_layout)
