	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		...
		<div class="header-elements d-none">
			<div class="breadcrumb justify-content-center">
				<a href="{{ route('admin.groups.update', ['id' => $groupTypes->id,'code' => request()->code]) }}" class="btn {{ config('erp.btn_class.update.class') }} btn-sm btn-actions btn-store" style="margin-left: 5px;">
...
<div class="row">
	<div class="col-md-12">
		...
		@slot('buttons', ['update'])
		@slot('edit', ['id' => $groupTypes->id, 'code' => request()->code])
		@slot('edit_design', $groupTypes->is_layout)
