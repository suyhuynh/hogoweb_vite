	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		...
		<div class="header-elements d-none">
			<div class="breadcrumb justify-content-center">
				<a href="{{ route('admin.units.update', ['id' => $units->id, 'code' => request()->code]) }}" class="btn {{ config('erp.btn_class.store.class') }} btn-sm btn-actions btn-store" style="margin-left: 5px;">
...
<div class="row">
	<div class="col-md-6 offset-md-3">
		...
		@slot('buttons', ['update'])
		@slot('resource', 'units')
		@slot('edit', ['id' => $units->id, 'code' => request()->code])
		@push('form')
