...
use Modules\Core\Http\Requests\SaveGroupTypeRequest;
class GroupTypeController extends Controller
{
     ...
     * @var string
     */
    protected $model = GroupTypes::class;
     ...
     * @var string
     */
    protected $label = 'core::group_types';
     ...
     * @var string
     */
    protected $viewPath = 'core::admin.group_types';
     ...
     * @var array|string
     */
    protected $validation = SaveGroupTypeRequest::class;
